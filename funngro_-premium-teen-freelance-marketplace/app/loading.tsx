...
export default function Loading() {
  return (
    <div className="flex-grow min-h-[80vh] w-full flex flex-col items-center justify-center p-6 text-center bg-zinc-950 relative">
